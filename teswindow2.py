...
class StartPage(Frame):
    ...
    def __init__(self, parent, master):
        ...
        button_count =  Menubutton ( self, text = "-",image=image_method_resize, relief = SUNKEN )
        button_count.grid(row = 3,column = 0,pady=2)
        button_count.menu  =  Menu ( button_count,tearoff=0)
        button_count["menu"]  =  button_count.menu
        button_count.menu.add_command(label = "1",command=count_pica)
        button_count.menu.add_command(label = "2",command=count_picb)
